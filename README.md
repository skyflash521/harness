...
- **flow**: 開発ワークフロー。実装・レビュー・コミットの進め方を規律づける。
  [導入契約](plugins/flow/docs/criteria/adoption.md)を満たすリポジトリで有効化する。
...
[導入契約の前提環境](plugins/flow/docs/criteria/adoption.md#前提環境)が定める。
...
**flow を有効化するリポジトリは[導入契約](plugins/flow/docs/criteria/adoption.md)の条項も満たす。**
